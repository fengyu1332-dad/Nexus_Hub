...
export type PipelineType = 'ai_publish' | 'embedding' | 'flora_auto_reply' | 'crawl' | 'dedup_check' | 'tag_classify' | 'semantic_search' | 'embedding_backfill' | 'newsletter_send' | 'atmosphere_builder' | 'ai_moderator'
